...
import usertemp from '../../../asset/img/addtemp.png';
import webtemp from '../../../asset/img/webtemp.png';
import './operbilityTable.css'
...
class Channelist extends React.Component {
    ...
    componentWillMount() {
        let gamedata =[
         ...
         //JSON.parse(window.sessionStorage.getItem("gameList"));
        ...
        //JSON.parse(window.sessionStorage.getItem("userList"));
        let Optiondata = [];
    ...
    ajaxSucessChannellist = (data) => {
        ...
        let channelList =data //JSON.parse(data)
        this.setState({
            dataSource: [],
            allDataSource: [],
        })
    ...
    addsucces = () => {
        ...
        this.ajaxSucessChannellist(temp)
    ...
    render() {
        ...
        console.log("请求的次数：", this.state.gamecout)
